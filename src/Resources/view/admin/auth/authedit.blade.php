...
<div class="alert bg-info">
    ...
    <ul type="circle" class="ul-list">
        ...
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="post" action="{{url('pack/admin/admin_auth_edit')}}">
                    @csrf
                    <input type="hidden" name="auth_id" value="{{$auth_first_info['id']}}">
                  <div class="layui-form-item">
                      <label for="username" class="layui-form-label">
                          <span class="x-red">*</span>权限名称
                      </label>
                      <div class="layui-input-inline">
                          <input type="text" value="{{$auth_first_info['auth_name']}}" id="username" name="auth_name" required="" lay-verify="required"
                        ...
                        <div class="layui-input-inline">
                            <select name="auth_pid">
                                ...
                                @foreach($auth_pid_list as $key => $value)
                                    <option @if ($auth_first_info['auth_pid'] != 0 && $auth_first_info['auth_pid'] == $value['id']) selected @endif value="{{$value['id']}}">{{$value['auth_name']}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="layui-form-mid layui-word-aux">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="auth_c" name="auth_c" required="" value="@if ($auth_first_info['auth_c']) {{$auth_first_info['auth_c']}} @else '0' @endif " lay-verify="required"
                                   autocomplete="off" class="layui-input" >
                        </div>
                        <div class="layui-form-mid layui-word-aux">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="auth_a" name="auth_a" required=""value="@if ($auth_first_info['auth_a']) {{$auth_first_info['auth_a']}} @else '0' @endif " lay-verify="required"
                                   autocomplete="off" class="layui-input" >
                        </div>
                        <div class="layui-form-mid layui-word-aux">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="auth_route" name="auth_route" required="" value="{{$auth_first_info['auth_route']}}" lay-verify="required"
                                   autocomplete="off" class="layui-input" >
                        </div>
                        <div class="layui-form-mid layui-word-aux">
