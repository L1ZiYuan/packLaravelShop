                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <a class="layui-btn layui-btn-normal" href="{{url('pack/admin/admin_member_add_view')}}"><i class="layui-icon"></i>添加</a>
                        </div>
                        <div class="layui-card-body ">
                              ...
                              <tbody>
                                    @foreach ($admin_list as $value)
                                        <tr>
                                            ...
                                            <td>
                                                {{$value->admin_auth_id == 0 ? '超级管理员' : '管理员'}}
                                            </td>
                                            <td>
                                                {{$value->created_at}}
                                            </td>
                                            ...
                                            <td class="td-manage">
                                                <a onclick="member_stop(this,{{$value->id}})" href="javascript:;"  title="启用">
                                                    <i class="layui-icon">&#xe601;</i>
                                                </a>
                                                <a title="编辑" href="{{ url('pack/admin/admin_edit?admin_id='.$value->id) }}">
                                                    <i class="layui-icon">&#xe642;</i>
                                                </a>
                                                @if ($value->admin_auth_id != 0)
