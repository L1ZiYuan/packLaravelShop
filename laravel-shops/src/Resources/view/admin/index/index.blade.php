@extends('pack::admin.parent.parent')
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="./index.html">LMS后台管理系统</a></div>
            <div class="left_open">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    <a href="javascript:;">{{ $admin_data['admin_name']  }}</a>
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
                        ...
                        <dd>
                            <a href="{{ url('pack/admin/loginout') }}">退出</a></dd>
                    </dl>
                </li>
            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('管理员','{{ url('pack/admin/admin_list')  }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>管理员</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('添加角色','{{ url('pack/admin/admin_role_list')  }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加角色</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('添加权限','{{ url('pack/admin/admin_auth_list') }}',true)">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加权限</cite></a>
                            </li>
                            <li>
